    ...
    <>
      <div name='contact' className={`w-full ${dark ? 'bg-gray-700 text-gray-200' : 'text-gray-700 bg-gray-200'} flex justify-center items-center p-4`}>
        <form action="https://getform.io/f/e1c71e22-0753-4800-a681-2ffaeb6f3102" className='sm:mt-36 flex flex-col max-w-[600px] w-full' method='POST'>
          ...
          <input className={`outline-none ${dark ? 'bg-slate-300 text-slate-700' : 'bg-slate-700 text-slate-300'} p-2`} type="text" placeholder='Name' name='name' />
          <input className={`outline-none ${dark ? 'bg-slate-300 text-slate-700' : 'bg-slate-700 text-slate-300'} my-4 p-2 bg-[#ccd6f6]`} type="email" placeholder='Email' name='name' />
          {/* <input type="email" placeholder='Email' name='name' /> */}
          <textarea className={`outline-none ${dark ? 'bg-slate-300 text-slate-700' : 'bg-slate-700 text-slate-300'} p-2 bg-[#ccd6f6]`} name="Message" id="" rows="6" placeholder='Your Message'></textarea>
