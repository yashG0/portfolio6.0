...
const Contact = () => {
  return (
   <>
    <div name='contact' className='w-full h-screen bg-[#0a192feb] flex justify-center items-center p-4'>
      <form action="https://getform.io/f/e1c71e22-0753-4800-a681-2ffaeb6f3102" className='flex flex-col max-w-[600px] w-full' method='POST'>
          <div className='pb-8 '>
          ...
          <textarea className='p-2 bg-[#ccd6f6] ' name="Message" id="" rows="10" placeholder='Your Message'></textarea>
