    ...
    <>
      <div name='hero' className={`w-full h-screen ${dark?'bg-gray-700 text-gray-200':'text-gray-700 bg-gray-200'}`}>
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full font-f1">
          ...
          <h1 className={`text-4xl sm:text-7xl font-bold ${dark?'text-gray-200':'text-gray-800'}  font-f1`}>Yash Gaurkar</h1>
          <h2 className={`text-4xl sm:text-7xl font-bold ${dark?'text-gray-300':'text-gray-700'} font-f1`}>I'm a Full Stack Developer.</h2>
          ...
          <div>
            <button className={`${dark?'hover:bg-blue-500 border-blue-500':'border-blue-500 hover:bg-blue-500'} group border-2 px-6 py-3 my-2 flex items-center duration-150 outline-none`} onClick={()=>window.open('resume.pdf', '_blank')}>View Resume
